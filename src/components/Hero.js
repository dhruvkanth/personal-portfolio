...
export const Hero = () => {
  ...
  const aboutMe =
    "I am a 19 year old software engineering student at University of Auckland." +
          ...
          <Col xs={12} md={6} xl={7}>
            <span className="tagline">
              <span
                ...
                data-rotate='[ "Software Engineering Student" ]'
              >
            ...
            <h1>{introName}</h1>
            <p>{aboutMe}</p>
            <a href={"#project"} className="hover-bob">
              Projects <ArrowRightCircle size={25} />
            </a>
          </Col>
          <Col xs={12} md={6} xl={5}>
            <TrackVisibility>
